    ...
    <div class="container">
        ...
        <div class="header-right">
            <div class="user">
                    ...
                    @endif
                <a href="{{route('user.select.package')}}" class="btn btn-default">Create Service</a>
            </div>
        </div>
    </div>
</header>
            ...
            <ul class="account-action">
                <li>
                    ...
                    <div class="account-dropdown">
                        <ul>
                            <li> <a href="{{route('user.select.package')}}"> <i class="fa fa-plus-circle"></i>Creat Service</a></li>
                            @if(Auth::guard('user')->user())
                                <li><a href="{{route('user.profile')}}"><i class="fa fa-user"></i>My account</a></li>
                                <li><a href="#"
                                   onclick="event.preventDefault();
                            ...
                            @elseif(Auth::guard('user')->user())
                                <li><a href="{{route('admin.dashboard')}}"><i class="fa fa-user"></i>Admin</a></li>
                                <li><a href="#"
                                       onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"><i class="fa fa-user"></i>Logout</a></li>
                                    <form id="logout-form" action="{{ route('admin.logout') }}" method="POST" style="display: none;">
