    		...
    		<div class="container">
              ...
              <div class="widget">
                ...
                <ul class="featured-list">
                  ...
                  <li>
                    <img alt="" src="/client_inc/assets/img/featured/img4.jpg">
                    <div class="hover">
                      <a href="#"><span>$49</span></a>
                    </div>
                  </li>
                  <li>
                    <img alt="" src="/client_inc/assets/img/featured/img5.jpg">
                    <div class="hover">
                      <a href="#"><span>$49</span></a>
                    </div>
                  </li>
                  <li>
                    <img alt="" src="/client_inc/assets/img/featured/img6.jpg">
                    <div class="hover">
                      <a href="#"><span>$49</span></a>
                    </div>
                  </li>
...
<option value="Adachal"><option value="Adagimon"><option value="Adea"><option value="Adilang"><option value="Adjumani"><option value="Adok"><option value="Adumi"><option value="Adwari"><option value="Agora"><option value="Agule"><option value="Aguliya"><option value="Agulul"><option value="Ajia"><option value="Ajono"><option value="Akaba"><option value="Akalu"><option value="Akilok"><option value="Akpokoa"><option value="Alebtong"><option value="Aloi"><option value="Alui"><option value="Amgamwa"><option value="Amilo"><option value="Amolatar"><option value="Amugo"><option value="Amuria"><option value="Amuru"><option value="Anaka"><option value="Anyavu"><option value="Anyiribu"><option value="Apac"><option value="Apala"><option value="Api"><option value="Apigikwe"><option value="Apoka"><option value="Apokori"><option value="Arapai"><option value="Aringa"><option value="Arinyapi"><option value="Arivu"><option value="Ariwa"><option value="Arua"><option value="Asasi"><option value="Aswa"><option value="Atanga I"><option value="Atar"><option value="Atiak"><option value="Atura"><option value="Atyak"><option value="Aupi"><option value="Awach"><option value="Awer">
...
<option value="Boroboro"><option value="Borough"><option value="Bubale"><option value="Bubba"><option value="Budadiri"><option value="Budaka"><option value="Bude"><option value="Bududa"><option value="Budzi"><option value="Bufumbo"><option value="Bugadi"><option value="Bugado"><option value="Buganza">
<option value="Bugaya"><option value="Bugema"><option value="Bugembe"><option value="Bugiri"><option value="Bugobero"><option value="Bugongi"><option value="Bugoye"><option value="Buhimba"><option value="Buhoba"><option value="Buhugu"><option value="Buija"><option value="Buikwe"><option value="Bujuko"><option value="Bukakata"><option value="Bukanya">
<option value="Bukedea"><option value="Bukhaweka"><option value="Bukoto"><option value="Bukuku"><option value="Bukumi"><option value="Bukusi"><option value="Bukuya"><option value="Bukwiri"><option value="Bulangira"><option value="Buliisa"><option value="Bulindi"><option value="Buluchecke">
...
<option value="Chepsikunya"><option value="Cheptui"><option value="Chondo"><option value="Curu"><option value="Cwero"><option value="Cyahafi"><option value="Danya"><option value="Delu"><option value="Dokolo"><option value="Entebbe"><option value="Erezeli"><option value="Eruba"><option value="Fort Portal"><option value="Gaba"><option value="Galiraya"><option value="Ganda"><option value="Gayaza"><option value="Gayaze"><option value="Gem"><option value="Gogonya"><option value="Gogonyo"><option value="Goli"><option value="Gombe"><option value="Goru"><option value="Gulu"><option value="Gurumu"><option value="Gwere"><option value="Hima"><option value="Hoima"><option value="Ibanda"><option value="Iganga"><option value="Ihungu">
...
<option value="Kabujogera"><option value="Kabwohe"><option value="Kachumbala"><option value="Kadugala"><option value="Kagadi"><option value="Kagamba"><option value="Kaganda"><option value="Kaiti"><option value="Kajjansi"><option value="Kakindu"><option value="Kakinga"><option value="Kakira"><option value="Kakiri"><option value="Kakoge"><option value="Kakoma"><option value="Kakumiro"><option value="Kalagi">
...
<option value="Kamdini"><option value="Kamirambazzi"><option value="Kammengo"><option value="Kampala"><option value="Kamuganguzi"><option value="Kamuli"><option value="Kamwenge"><option value="Kangole"><option value="Kanoni"><option value="Kanungu"><option value="Kanyum"><option value="Kanyumu"><option value="Kanzhobe"><option value="Kapchorwa"><option value="Kapeka"><option value="Kapelebyong"><option value="Kapujan"><option value="Kasanda"><option value="Kasese"><option value="Kashongi"><option value="Kasodo"><option value="Kasowa"><option value="Katakwi"><option value="Katanabirwa">
